										...
										<ul>
											<li>
												<a href="product-detail-1.html">
													<figure><img src={{asset('assets/img/products/product_placeholder_square_small.jpg')}} data-src="assets/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
											...
											<li>
												<a href="product-detail-1.html">
													<figure><img src={{asset('assets/img/products/product_placeholder_square_small.jpg')}} data-src="assets/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
...
{{--										 {{ Session::get('current_account')}}--}}
										@if(Session::has('current_account'))
											{{Session::get('current_account')->fullName}}
											<ul>
												<li>
