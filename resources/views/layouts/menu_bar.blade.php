...
{{--                    <div id="logo">--}}
{{--                        <a href="{{route('home')}}"><img src={{asset('assets/img/logo.svg')}} alt="" width="100"--}}
{{--                                                         height="35"></a>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                    <div class="main-menu">--}}
{{--                        <div id="header_menu">--}}
{{--                            <a href="{{route('home')}}"><img src={{asset('assets/img/logo_black.svg')}} alt=""--}}
...
{{--                                                        data-src="assets/img/banner_menu.jpg" width="400" height="550"--}}
                                    ...
                                    <ul>
                                        <li>
                                            <a href="product-detail-1.html">
                                                <figure><img
                                                        src="{{asset('assets/img/products/product_placeholder_square_small.jpg')}}"
