                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card-box widget-box-four">
                                ...
                                <div class="float-left">
                                    ...
                                    <h3 class="mb-0 mt-2"><span>$</span> <span data-plugin="counterup">5,2548</span>
                                    </h3>
                                </div>
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card-box widget-box-four">
                                ...
                                <div class="float-left">
                                    ...
                                    <p class="font-secondary text-muted">Jan - Apr 2019</p>
                                    <h3 class="mb-0 mt-2"><span>$</span> <span data-plugin="counterup">65,241</span>
                                    </h3>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card-box widget-box-four">
                                ...
                                <div class="float-left">
                                    ...
                                    <p class="font-secondary text-muted">Jan - Apr 2019</p>
                                    <h3 class="mb-0 mt-2"><span>$</span> <span data-plugin="counterup">28,5960</span>
                                    </h3>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="mt-3 mb-3">
                                                ...
                                                <p class="text-uppercase mb-1 font-13 font-weight-normal">Lifetime total
                                                    sales</p>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mt-3 mb-3">
                                                ...
                                                <p class="text-uppercase mb-1 font-13 font-weight-normal">Income
                                                    amounts</p>
                                            </div>
                                        </div>
                                        <div class="col-4">
                ...
                <div class="col-xl-4">
                    <div class="card-box text-center">
                        <div class="text-center">
                            ...
                            <h3 class="mb-3"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> 48948
                                <small>USD</small></h3>
                        </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="mb-1">
                            ...
                            <p class="mb-1">Praesent libero. Nunc nec dui vitae urna cursus lacinia. In venenatis eget
