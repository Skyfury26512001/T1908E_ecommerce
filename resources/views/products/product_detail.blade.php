	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url({{asset('assets/img/products/shoes/1.jpg')}});" class="item-box"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/2.jpg')}});" class="item-box"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/3.jpg')}});" class="item-box"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/4.jpg')}});" class="item-box"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/5.jpg')}});" class="item-box"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/6.jpg')}});" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url({{asset('assets/img/products/shoes/1.jpg')}});" class="item active"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/2.jpg')}});" class="item"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/3.jpg')}});" class="item"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/4.jpg')}});" class="item"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/5.jpg')}});" class="item"></div>
	                            <div style="background-image: url({{asset('assets/img/products/shoes/6.jpg')}});" class="item"></div>
	                        </div>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="prod_info">
	                    ...
	                    <div class="prod_options">
	                        ...
	                        <div class="row">
	                            <label class="col-xl-5 col-lg-5 col-md-6 col-6"><strong>Size</strong> - Size Guide <a href="#" data-toggle="modal" data-target="#size-modal"><i class="ti-help-alt"></i></a></label>
	            ...
	            <div class="row">
	                <div class="col-md-7">
	                    <div class="item_panel">
	                        <figure>
	                            <img src="{{asset('assets/img/products/product_placeholder_square_small.jpg')}}" data-src="assets/img/products/shoes/1.jpg" class="lazy" alt="">
	                        </figure>
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{asset('assets/img/products/product_placeholder_square_small.jpg')}}" data-src="assets/img/products/shoes/2.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
	            ...
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{asset('assets/img/products/product_placeholder_square_small.jpg')}}" data-src="assets/img/products/shoes/3.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
	            ...
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{asset('assets/img/products/product_placeholder_square_small.jpg')}}" data-src="assets/img/products/shoes/4.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
