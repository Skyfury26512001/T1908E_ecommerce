...
@section('specific_css')
    ...
    <link href="{{asset('assets/css/required.css')}}" rel="stylesheet">
@endsection
@section('specific_js')
{{--	<script>--}}
{{--    	// Client type Panel--}}
			...
			<div class="col-xl-6 col-lg-6 col-md-8">
				<div class="box_account">
					...
					<form action="{{route('registerP')}}" method="POST">
						...
						<div class="form_container">
						<div class="form-group">
							<input type="email" class="form-control" name="email_regis" id="email_2" placeholder="Email*">
						</div>
                            @if ($errors->has('email_regis'))
                                <div class="required_field">
                                    <span >{{$errors->first('email_regis')}}</span>
                                </div>
                            @endif
						<div class="form-group">
							<input type="password" class="form-control" name="password_regis" id="password_in_2" value="" placeholder="Password*">
						</div>
                            @if ($errors->has('password_regis'))
                                <div class="required_field">
                                    <span >{{$errors->first('password_regis')}}</span>
                                </div>
                            @endif
						<hr>
{{--						<div class="form-group">--}}
